...
Read-only reference material for the demo: the spec never names it, and the
model has no reason to open it. Worth having in the repo map so you can see
what a file outside the spec's Context section looks like from the model's
side.
